...
- 위에서도 확인했지만, 4, 20으로 기입된 데이터 수 한번 더 체크하기  
  ...
  ![1760665973236](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760665973236.png>)
...
- `accounts_school(학교 테이블)`의 정보를 끌고와서 `school_id`를 매칭하여 해당 유저 정보 확인  
  ...
  ![1760662815335](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760662815335.png>)
...
- 매칭 실패된 `school_id` 정보  
  ...
  ![1760668014985](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760668014985.png>)

<br>

- `accounts_group`에서 `school_id` 컬럼 값이 1인 데이터 수

  ![1760667934486](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760667934486.png>)

<br>

- `school_type`이 NULL로 나온 데이터 수 : **26**  
  
  ![1760668181298](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760668181298.png>)
...
| 분석 항목                    | 결과      | 해석                                                |
| ------------------------ | ------- | ------------------------------------------------- |
| 각 학교의 인근 학교 수            | 10개로 동일 | 거리순 정렬 기준으로 **자기 자신 포함 시 10개**, 제외 시 **9개 인근 학교** |
| NULL 값                   | 0건      | 데이터 품질 매우 양호                                      |
| 전체 관계 수 (59,500 ÷ 5,950) | = 10    | 완전한 1:N 구조 (학교당 10개 인근 학교 관계)                     |


---

### 기준 학교당 인근 학교 데이터 수 분포(`각 학교의 인근 학교 수 10개로 동일 설명`)
...
![1760682045852](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760682045852.png>)
...
![1760682255118](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760682255118.png>)
...
- 학교 별로 뷰에 정보가 잘 들어갔는지 확인 시 5,950건 확인
  ...
  ![1760683678789](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760683678789.png>)

<br>

- `accounts_nearbyschool` 테이블의 고유 학교 수 5,950건과 일치

  ![1760683769840](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760683769840.png>)
...
- `dnesity(밀집도)` 매칭 결과
  ...
  ![1760684719560](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760684719560.png>)
...
- 쿼리 결과
  ...
  ![1760684865593](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760684865593.png>)
...
- 쿼리 결과
  ...
  ![1760684995668](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760684995668.png>)
...
- 쿼리 결과
  ...
  ![1760685394767](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760685394767.png>)
...
- 쿼리 결과
  ...
  ![1760685640395](<image/Day2_협업일지(고급)_DA_08_1팀_정유빈/1760685640395.png>)
